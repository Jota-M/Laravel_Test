        ...
        <section class="shop" id="shop">
            ...
            <div class="shop-content">
                <div class="row">
                    ...
                    <h3>Hamburguesa Mounstruo</h3>
                    <p>Con porcion de papas incluido</p>
                    <div class="in-text">
                        <div class="price">
                            <h6>$21.00</h6>
                        </div>
                ...
                <div class="row">
                    <img src="../img-P/p4.png" alt="">
                    <h3>Salchicarne jumbo</h3>
                    <p>It is a long established fact that a reader</p>
                    <div class="in-text">
                        <div class="price">
                            <h6>$21.00</h6>
                ...
                <div class="row">
                    <img src="../img-P/p5.png" alt="">
                    <h3>Chorripanes a la parrilla</h3>
                    <p>It is a long established fact that a reader</p>
                    <div class="in-text">
                        <div class="price">
                            <h6>$21.00</h6>
                ...
                <div class="row">
                    <img src="../img-P/p6.png" alt="">
                    <h3>Pacumutu especial</h3>
                    <p>It is a long established fact that a reader</p>
                    <div class="in-text">
                        <div class="price">
                            <h6>$21.00</h6>
                ...
                <div class="row">
                    <img src="../img-P/p7.png" alt="">
                    <h3>Papas Fritas Explosivas</h3>
                    <p>It is a long established fact that a reader</p>
                    <div class="in-text">
                        <div class="price">
                            <h6>$21.00</h6>
